...
class BankAcccount implements BankAcccount {
    accountNumber:number;
    balance:number;
...
class Customer{
    ...
    constructor(firstName: string, lastName: string, age: number, gender: string, mobileNumber: number, account: BankAcccount  ){
